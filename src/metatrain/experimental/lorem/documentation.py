...
class LoremLongRangeHypers(LongRangeHypers):
    """Long-range Coulomb hyperparameters. Enabled by default, matching LOREM."""

    enable: bool = True
    """Toggle for enabling long-range interactions. LOREM is designed to be
    used with this on."""
    use_ewald: bool = True
